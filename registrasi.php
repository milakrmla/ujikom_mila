...
<head>
    ...
    <title>Sign Up | Galeri Foto</title>
    <!-- favicon -->
...
<body>
    ...
    <div class="container mt-3">
        <div class="text-center">
            <h5 style="font-weight: bold;"><i class="fa-solid fa-right-to-bracket" style="color: #2d3250;"></i> SIGN UP</h5>
        </div>
                ...
                <div class="card" style="background: #7077A1; border-radius: 2%;">
                        <div class="card-body text-white mt-2">
                            <form action="config/aksi_registrasi.php" method="POST">
                                ...
                                <label class="form-label mt-2" for="password2">Konfirmasi Password</label>
                                ...
                                <div class="d-grid mt-3">
                                    <button class="btn custom-btn3 btn-round" type="submit" name="kirim">SIGN UP</button>
                                </div>
                            </form>
                            <hr>
                            <p>Sudah punya akun? <a href="login.php" style="color:#F6B17A;">Login</a></p>
                        </div>
                    </div>
                </div>
            </div>    
    ...
    <!-- footer -->
    <footer class="d-flex justify-content-center border-top mt-5 bg-white">
